# Math-Expositions - Guilherme Souza
Stanford Course Projects: Basel Problem, Infinite Square Well, Constructibility

**Basel Problem (Math 171)**: Proof of the Basel Problem by deriving the necessary tools from Fourier Theory. Discussion of the necessary summability and integrability conditions to derive Parseval's identity in a sufficiently general case to apply it to the Basel Problem.
